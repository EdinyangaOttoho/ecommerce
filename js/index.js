...
function create() {
	if (a1 == true && a2 == true && a3 == true) {
    	...
    	xhttp.onreadystatechange = function() {
    		if (this.readyState == 4 && this.status == 200) {
    			if (this.responseText != 'error') {
                    window.location.replace('https://www.247naijaforum.com/ecommerce/index.php');
               }
               else {
    	...
    	xhttp.open('POST','https://www.247naijaforum.com/ecommerce/settings.php',true);
    	xhttp.send(data);
    }
    else {
...
function searchnow(x) {
    ...
    if (x.length >= 2) {
        ...
        xhttp.open('POST','https://www.247naijaforum.com/ecommerce/settings.php?qstr='+x,true);
        xhttp.send();
    }
}
